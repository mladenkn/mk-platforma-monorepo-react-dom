...
export const PostScalarFieldEnumSchema = z.enum([
  ...
  "location_id",
  "author_id",
  "expertEndorsement_id",
  "isDeleted",
])

export const Post_ExpertEndorsementScalarFieldEnumSchema = z.enum([
  "id",
  "post_id",
  "firstName",
  "lastName",
...
export const Post_ExpertEndorsement_skillScalarFieldEnumSchema = z.enum([
  "id",
  "label",
  "level",
  "expertEndorsement_id",
...
export const Category_labelSchema = z.enum([
  "job",
  "job_demand",
  "accommodation",
...
export const LocationSchema = z.object({
  ...
  latitude: z
    ...
    .refine(v => isValidDecimalInput(v), {
      message: "Field 'latitude' must be a Decimal. Location: ['Models', 'Location']",
    }),
  longitude: z
    .union([z.number(), z.string(), DecimalJSLikeSchema])
    .refine(v => isValidDecimalInput(v), {
      message: "Field 'longitude' must be a Decimal. Location: ['Models', 'Location']",
    }),
  name: z.string(),
  country: z.string(),
